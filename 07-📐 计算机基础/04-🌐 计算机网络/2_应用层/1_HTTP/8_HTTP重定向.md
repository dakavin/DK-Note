...
文章作者: Dakkk
文章概要: |
  本文深入解析HTTP重定向，重点阐述301（永久）和302（临时）状态码及其Location头字段。文章探讨了重定向的应用场景，并强调了性能开销与避免循环跳转的关键注意事项。
tags:
- "HTTP"
- "重定向"
- "301"
...
- "[[3_Part3_BUG]]"
文章分类: "📐 计算机基础"
文章路径: "07-📐 计算机基础/04-🌐 计算机网络/2_应用层/1_HTTP/8_HTTP重定向.md"
文章难度: 初级 💧
目前阶段: ✅ 已完成
重要性: ⭐⭐⭐⭐⭐ 精通必备
...
例如，如果想跳转到 Nginx 官网，就必须在“nginx.org”前把“http://”都写出来，否则浏览器会按照相对 URI 去理解，得到的就会是一个不存在的 URI“[http://www.chrono.com/nginx.org”](http://www.chrono.com/nginx.org%E2%80%9D)
