...
![](https://image-for.oss-cn-guangzhou.aliyuncs.com/for-obsidian/Java_Study/2_%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Pasted%20image%2020230925141913.png)
...
用git下载[github](https://so.csdn.net/so/search?q=github&spm=1001.2101.3001.7020)上的大项目时，本地空间也足够，也安装LFS了，可还没有下载完就失败了，如下所示：
![](https://image-for.oss-cn-guangzhou.aliyuncs.com/for-obsidian/Java_Study/2_%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Pasted%20image%2020230925143025.png)
...
```shell
git initgit clone 项目ssh地址
```
### 4.2 认识Dubbo Samples项目结构
...
从 [1、背景](#1、背景) 一节中可知，运行起 Dubbo 应用的`一个大前提是部署一个注册中心`，为了让本教程更易于上手，我们提供了`一个基于 Apache Zookeeper 注册中心的简易启动`器，如果您需要在生产环境部署注册中心，请参考[生产环境初始化](https://cn.dubbo.apache.org/)一文部署高可用的注册中心。
...
- 注意：windows系统下，因为mvnw.cmd文件已经存在于这个目录下了，所以就不用再命令前面加`./`

在执行完上述命令以后，等待一会出现如下图所示的日志即代表注册中心启动完毕，可以继续执行后续任务。![](https://image-for.oss-cn-guangzhou.aliyuncs.com/for-obsidian/Java_Study/2_%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Pasted%20image%2020230925145842.png)
- `注册中心会持续检测是否有zookeeper客户端`
...
![](https://image-for.oss-cn-guangzhou.aliyuncs.com/for-obsidian/Java_Study/2_%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Pasted%20image%2020230925150250.png)
...
![](https://image-for.oss-cn-guangzhou.aliyuncs.com/for-obsidian/Java_Study/2_%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Pasted%20image%2020230925150344.png)
...
![](https://image-for.oss-cn-guangzhou.aliyuncs.com/for-obsidian/Java_Study/2_%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Pasted%20image%2020230925150437.png)
...
1）启动一个注册中心，可以参考动手实践中第 3 小节的[教程](https://cn.dubbo.apache.org/zh-cn/overview/quickstart/java/brief/#3-%E5%90%AF%E5%8A%A8%E4%B8%80%E4%B8%AA%E7%AE%80%E6%98%93%E7%9A%84%E6%B3%A8%E5%86%8C%E4%B8%AD%E5%BF%83)
...
3）启动第一个服务提供者，可以参考动手实践中第 4 小节的[教程](https://cn.dubbo.apache.org/zh-cn/overview/quickstart/java/brief/#4-%E5%90%AF%E5%8A%A8%E6%9C%8D%E5%8A%A1%E6%8F%90%E4%BE%9B%E8%80%85)
...
4）启动第二个服务提供者，可以参考动手实践中第 4 小节的[教程](https://cn.dubbo.apache.org/zh-cn/overview/quickstart/java/brief/#4-%E5%90%AF%E5%8A%A8%E6%9C%8D%E5%8A%A1%E6%8F%90%E4%BE%9B%E8%80%85)

5）启动服务消费者，可以参考动手实践中第 5 小节的[教程](https://cn.dubbo.apache.org/zh-cn/overview/quickstart/java/brief/#5-%E5%90%AF%E5%8A%A8%E6%9C%8D%E5%8A%A1%E6%B6%88%E8%B4%B9%E8%80%85)。多次启动消费者可以看到返回的结果是不一样的。
...
下一个教程中，将就服务提供者和服务消费者分别都做了什么配置进行讲解，[从零告诉你如何搭建一个微服务应用](https://cn.dubbo.apache.org/zh-cn/overview/quickstart/java/api/)。