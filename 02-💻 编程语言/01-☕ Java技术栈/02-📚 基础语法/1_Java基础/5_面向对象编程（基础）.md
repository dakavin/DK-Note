...
文章作者: Dakkk
文章概要: |
  本文详细介绍了Java面向对象编程基础，涵盖了面向对象与面向过程的对比、类与对象的概念、类的成员（属性、方法、构造器）的定义与使用。同时，文章深入探讨了JVM内存结构、方法重载、可变参数、值传递机制及递归，并重点讲解了封装性的实现与重要性。
文章标签:
- "OOP"
- "Java"
- "类与对象"
...
- "[[1_Java基本数据类型]]"
文章分类: "💻 编程语言"
文章路径: "02-💻 编程语言/01-☕ Java技术栈/02-📚 基础语法/1_Java基础/5_面向对象编程（基础）.md"
文章难度: 初级 💧
目前阶段: ✅ 已完成
重要性: ⭐⭐⭐⭐⭐ 精通必备
...
![|380](https://my-obsidian-image.oss-cn-guangzhou.aliyuncs.com/2024/04/44e7803d2f7747700407af3a235dc63e.png)
...
用面向对象思想思考“如何设计车”：
![|380](https://my-obsidian-image.oss-cn-guangzhou.aliyuncs.com/2024/04/6e879bc87b8d8d679a9315a6011dd19a.png)

自然地，我们就会从“车由什么组成”开始思考。发现，车由如下结构组成:![|380](https://my-obsidian-image.oss-cn-guangzhou.aliyuncs.com/2024/04/fcc3f3cbb74e3b7ce94a1ae5a4287461.png)
...
![|380](https://my-obsidian-image.oss-cn-guangzhou.aliyuncs.com/2024/04/f3feb8803ccfa439b82f8ae1e5b654c6.png)
...
![|380](https://my-obsidian-image.oss-cn-guangzhou.aliyuncs.com/2024/04/9e8abd38234120a29164c0db3e88b8ab.png)
