---
文章标题: "[[18_JDK8-17新特性（下）]]" 
文章作者: Dakkk
文章概要: |
  本文详细介绍了JDK 9至17版本中的关键新特性，涵盖了jShell交互工具、var类型推断、try-with-resources增强、instanceof和switch模式匹配、文本块、Record和密封类等新语法。同时，文章也阐述了Optional和String API的改进，以及G1、Shenandoah和ZGC等垃圾回收器的重要演进，旨在提升开发效率、代码质量和应用性能。
tags:
- "JDK新特性"
- "Java新语法"
- "JVM垃圾回收"
...
- "[[Java8 新特性]]"
文章分类: "💻 编程语言"
文章路径: "02-💻 编程语言/01-☕ Java技术栈/02-📚 基础语法/1_Java基础/18_JDK8-17新特性（下）.md"
文章难度: 中级 🌳
目前阶段: ✅ 已完成
重要性: ⭐⭐⭐⭐ 核心能力
