---
文章标题: "[[8_Linux系统软件安装-2]]" 
文章作者: Dakkk
文章概要: |
  介绍Linux集群化环境部署，包括多台虚拟机配置、主机名映射、SSH免密登录，以及Zookeeper、Kafka、Hadoop、HBase、Spark、Flink等大数据组件的集群安装部署方法。
tags:
- "Linux集群"
- "Hadoop"
- "Zookeeper"
...
相关文章: 暂无 🤷
文章分类: "🐧 Linux系统"
文章路径: "06-🐧 Linux系统/02-⚙️ 系统基础/01-💻 命令行操作/8_Linux系统软件安装-2.md"
文章难度: 中级 🌳
目前阶段: ✅ 已完成
重要性: ⭐⭐⭐⭐ 核心能力
