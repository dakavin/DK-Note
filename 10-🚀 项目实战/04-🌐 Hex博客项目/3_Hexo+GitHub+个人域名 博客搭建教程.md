---
文章标题: "[[3_Hexo+GitHub+个人域名 博客搭建教程]]"
文章作者: Dakkk
文章概要: |
  本文详细指导如何利用Hexo静态博客框架和GitHub Pages搭建个人博客，并绑定个人域名。教程涵盖环境准备、Hexo配置与部署、GitHub仓库操作、域名解析及博客备份，为初学者提供一站式搭建指南。
文章标签:
  - Hexo
  - GitHub Pages
  - 个人博客
...
文章分类: 🚀 项目实战
文章路径: 10-🚀 项目实战/04-🌐 Hex博客项目/3_Hexo+GitHub+个人域名 博客搭建教程.md
文章难度: 初级 💧
目前阶段: ✅ 已完成
重要性: ⭐⭐⭐⭐ 核心能力
创建时间: 2024-08-11 18:15:12
修改时间: 2025-05-27 01:03:43
---
...
也可以使用本地可视化工具，具体见文章[3_gitkralen的破解及汉化](../../08-🛠️%20开发工具/02-🔧%20版本控制/04-💡%20实用技巧/3_gitkralen的破解及汉化.md)
