...
文章作者: Dakkk
文章概要: |
  文章详述Java序列化概念、应用场景及协议层级。对比JDK内置序列化（性能、安全、跨语言缺陷）与Kryo、Protobuf、Hessian等主流方案。建议纯Java用Kryo，跨语言用Protobuf等，并解析serialVersionUID和transient作用。
文章标签:
- "Java"
- "序列化"
- "反序列化"
...
- "[[0_链表理论基础]]"
文章分类: "🎉 面试"
文章路径: "11-🎉 面试/1_JavaGuide/1_Java面试题/1_Java基础重要知识点‼️/2_Java序列化详解.md"
文章难度: 初级 💧
目前阶段: ✅ 已完成
重要性: ⭐⭐⭐⭐⭐ 精通必备
创建时间: 2024-08-11 18:15:12
修改时间: 2025-05-27 01:06:33
---
