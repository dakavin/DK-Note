...
文章作者: Dakkk
文章概要: |
  文章深入剖析Java `Object`类核心方法，特别是`equals()`、`hashCode()`与`==`的区别和应用。它解释了这些方法在集合框架中的关键作用，并强调了重写`equals()`时必须同步重写`hashCode()`的重要性及原因。
文章标签:
- "Java"
- "Object类"
- "equals"
...
文章分类: "🎉 面试"
文章路径: "11-🎉 面试/1_JavaGuide/1_Java面试题/1_Java基础常见面试题/7_Object.md"
文章难度: 中级 🌳
目前阶段: ✅ 已完成
重要性: ⭐⭐⭐⭐⭐ 精通必备
创建时间: 2024-08-11 18:15:12
修改时间: 2025-05-27 01:05:50
---
...
![|380](https://my-obsidian-image.oss-cn-guangzhou.aliyuncs.com/2024/04/9907321a2ee9c8947a1bc2d0d4102a00.png)
...
**思考**：重写 `equals()` 时没有重写 `hashCode()` 方法的话，使用 `HashMap` 可能会出现什么问题。
	即使两个对象的内容相等，它们的哈希码也不一定相等，会导致无法正确地插入、查找或删除对象
**总结**：
